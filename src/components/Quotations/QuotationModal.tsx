...
export const QuotationModal: React.FC<QuotationModalProps> = ({
  ...
  const setupNewQuoteForCustomer = (cust: Customer, resetItems: boolean = true) => {
    ...
    setHeaderFooterConfig((prev) => ({
      ...
      salesRepName: cust.assignedToName || currentUser.name,
  ...
  const buildQuotationPayload = (status: 'draft' | 'sent' | 'negotiating' = 'sent'): Quotation => {
    return {
      ...
      salesRepId: selectedCustomer?.assignedToId || currentUser.id,
      salesRepName: headerFooterConfig.salesRepName || selectedCustomer?.assignedToName || currentUser.name,
