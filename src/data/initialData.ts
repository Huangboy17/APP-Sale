...
export const INITIAL_ORGANIZATIONS = [
  ...
  {
    id: 'org-c1-2',
    ownerId: 'user-mgr-c1-2',
    ownerName: 'Lê Thị Hương',
    name: 'Công ty CP Green Interiors',
...
export const INITIAL_USERS: User[] = [
  ...
  },
  {
    id: 'user-sales-1',
    name: 'Nguyễn Thị Mai',
    email: 'mai.nguyen@salesflow.vn',
    role: 'sales_c2',
    phone: '0901 888 999',
    password: '123456',
    status: 'active',
    organizationId: 'org-c1-1',
    parentId: 'user-mgr-c1-1',
    managerId: 'user-mgr-c1-1',
  ...
  },
  {
    id: 'user-sales-3',
    name: 'Võ Thanh Tùng',
    email: 'tung.vo@salesflow.vn',
    role: 'sales_c2',
    phone: '0944 555 666',
    password: '123456',
    status: 'active',
    organizationId: 'org-c1-2',
    parentId: 'user-mgr-c1-2',
    managerId: 'user-mgr-c1-2',
...
export const INITIAL_CUSTOMERS: Customer[] = [
  ...
  },
  {
    ...
    assignedToId: 'user-sales-1',
    assignedToName: 'Nguyễn Thị Mai',
    memberIds: ['user-sales-1', 'user-sales-2', 'user-mgr-c1-1'],
    createdBy: 'user-mgr-c1-1', // Cấp 1 giao việc và chia sẻ quyền
